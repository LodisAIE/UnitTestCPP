...
namespace UnitTest1
{
    static const float DEFAULT_TOLERANCE = 0.0001f;
	...
	public:
        ...
        TEST_METHOD(Vector3Addition)
        {
            ...
            Assert::IsTrue(compare(Vector3(18.5f, -44.24f, 850), v3c));
        }
        ...
        TEST_METHOD(Vector4Addition)
        {
            ...
            Assert::IsTrue(compare(Vector4(18.5f, -44.24f, 850, 1), v4c));
        }
        ...
        TEST_METHOD(Vector3Subtraction)
        {
            ...
            Assert::IsTrue(compare(Vector3(8.5f, -52.22f, 874), v3c));
        }

        TEST_METHOD(Vector4Subtraction)
        {
            Vector4 v4a = Vector4(13.5f, -48.23f, 862, 0);
            Vector4 v4b = Vector4(5, 3.99f, -12, 1);
            Vector4 v4c = v4a - v4b;

            Assert::IsTrue(compare(Vector4(8.5f, -52.22f, 874, -1), v4c));
        }

        TEST_METHOD(Vector3PostScale)
        {
            Vector3 v3a = Vector3(13.5f, -48.23f, 862);
            Vector3 v3c = v3a * 0.256f;

            Assert::IsTrue(compare(Vector3(3.45600008965f, -12.3468809128f, 220.672012329f), v3c));
        }

        TEST_METHOD(Vector4PostScale)
        {
            Vector4 v4a = Vector4(13.5f, -48.23f, 862, 0);
            Vector4 v4c = v4a * 4.89f;

            Assert::IsTrue(compare(Vector4(66.0149993896f, -235.844696045f, 4215.1796875f, 0), v4c));
        }

        TEST_METHOD(Vector3PreScale)
        {
            Vector3 v3a = Vector3(13.5f, -48.23f, 862);
        ...
        TEST_METHOD(Vector3Cross)
        {
            ...
            Assert::IsTrue(compare(v3c, Vector3(-2860.62011719f, 4472.00000000f, 295.01498413f)));
        }
        ...
        TEST_METHOD(Vector4Cross)
        {
            ...
            Assert::IsTrue(compare(v4c, Vector4(-2860.62011719f, 4472.00000000f, 295.01498413f, 0)));
        }
        ...
        TEST_METHOD(Vector3Normalise)
        {
            Vector3 v3a = Vector3(13.5f, -48.23f, 862);
            v3a = Vector3::normalize(v3a);

            Assert::IsTrue(compare(v3a, Vector3(0.0156349f, -0.0558571f, 0.998316f)));
        }

        TEST_METHOD(Vector4Normalise)
        {
            Vector4 v4a = Vector4(243, -48.23f, 862, 0);
            v4a = Vector4::normalize(v4a);

            Assert::IsTrue(compare(v4a, Vector4(0.270935f, -0.0537745f, 0.961094f, 0)));
        }

        TEST_METHOD(Matrix4SetRotateX)
        {
            Matrix4 m4a = Matrix4();
        ...
        TEST_METHOD(Vector3MatrixTransform2)
        {
            Matrix3 m3c = Matrix3();
        ...
        TEST_METHOD(Vector4MatrixTransform)
        {
            Matrix4 m4b = Matrix4();
        ...
        TEST_METHOD(Vector4MatrixTransform2)
        {
            Matrix4 m4c = Matrix4();
        ...
        TEST_METHOD(Vector3MatrixTranslation)
        {
            ...
            Assert::IsTrue(compare(v3b, Vector3(68.5f, -4.23f, 1)));
        }


        TEST_METHOD(Vector4MatrixTranslation)
        {
            // homogeneous point translation
            ...
            Vector4 v4c = m4b * v4a;
            Assert::IsTrue(compare(v4c, Vector4(68.5f, -4.23f, 45, 1)));
        }

        TEST_METHOD(Vector4MatrixTranslation2)
        {
            // homogeneous point translation
            Matrix4 m4c =  Matrix4();
            ...
            Vector4 v4c = m4c * v4a;
            Assert::IsTrue(compare(v4c,  Vector4(86.0490112305f, 83.2981109619f, 45, 1)));
        }

        TEST_METHOD(Vector3MatrixTranslation3)
        {
            // homogeneous point translation
            Matrix3 m3b = Transpose( Matrix3(1, 0, 0,
                0, 1, 0,
            ...
            Assert::IsTrue(compare(v3b,  Vector3(13.5f, -48.23f, 0)));
        }

        TEST_METHOD(Vector4MatrixTranslation3)
        {
            // homogeneous point translation
            Matrix4 m4b = Transpose( Matrix4(1, 0, 0, 0,
                0, 1, 0, 0,
            ...
            Vector4 v4c = m4b * v4a;
            Assert::IsTrue(compare(v4c,  Vector4(13.5f, -48.23f, -54, 0)));
        }

        TEST_METHOD(Vector4MatrixTranslation4)
        {
            // homogeneous point translation
            Matrix4 m4c =  Matrix4();
            m4c = Transpose(Matrix4::createRotationZ(2.2f));
            ...
            Vector4 v4c = m4c * v4a;
            Assert::IsTrue(compare(v4c,  Vector4(31.0490131378f, 39.2981109619f, -54, 0)));
        }
	};
}
